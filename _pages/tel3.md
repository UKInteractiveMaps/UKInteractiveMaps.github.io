    ...
    <body>
        ...
        <div id="inner-content">
          ...
          <div class="uk-election-graphics">
            ...
            <div id="results-bar" class="uk-election-graphic"></div>
            <div class="two-col">
...
<!--
          <div style='padding-top: 60px;' class="two-col">
            <a class="twitter-timeline" href="https://twitter.com/business" data-widget-id="595262812366200832" width="100%" height="900px" data-chrome="noborders noheader noscrollbar" data-tweet-limit="5">Tweets from https://twitter.com/business/lists/uk-election-2015</a>
